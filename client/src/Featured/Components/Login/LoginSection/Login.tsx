  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-white relative">
      <div className="relative z-10 bg-white shadow-lg rounded-xl p-10 w-[476px] h-[704px] border border-gray-100 overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex flex-col  mb-6">
            ...
            <p className="text-[16px] text-gray-500 mb-4 items-start ">
          ...
          <form className="space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <div className="w-full border flex items-center justify-center gap-2 border-slate-200 rounded-md py-3 text-sm mb-3 bg-white/70 backdrop-blur">
                <img
      ...
      <div className="absolute bottom-6 text-sm text-gray-400 text-center">
        <p>
          Copyright ©{" "}
          <span className="font-medium text-gray-600">JobBoardly X</span> |
          Designed by BRIX Templates - Powered by Webflow
        </p>
      </div>
    </section>
  );
