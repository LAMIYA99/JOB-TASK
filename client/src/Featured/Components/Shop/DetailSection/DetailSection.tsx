import { Briefcase, BriefcaseBusiness, ChartNoAxesColumnIncreasing, CircleDollarSign, Clock, MapPin } from "lucide-react";
      ...
      <div className=" mx-auto container  max-w-[1130px] px-6 py-6 grid grid-cols-12 gap-6 ">
        ...
        <aside className="col-span-12 lg:col-span-3 space-y-6">
          ...
          <div className="bg-white shadow-sm rounded-lg p-5">
            <div className="mb-2">
              <img className="w-9 h-9" src="https://cdn.prod.website-files.com/6499e85e700d7e4fd7af113d/64bfe91d7095177ffdb5693d_post-a-job-icon-jobboardly-webflow-ecommerce-template.jpg" alt="" />
            </div>
